...
def display_items():
    ...
    return render_template("newitems.html", items=items, user=current_user)
...
def checkout():    
    ...
    # POST is when the form is filled out and submit btn in checkout.html is pressed
    if request.method == "POST":
        shipping_addr = request.form.get("shipping-address")
        billing_addr = request.form.get("billing-address")
        payment_method = request.form.get("payment-method")
        return render_template("confirmation.html",shipping=shipping_addr, cart=cart, user=current_user)
...
def payment():
    ...
    payment_method = request.form.get("payment-method")
    address = []
    address.append({"shipping":shipping_addr, "billing": billing_addr})

    return render_template("confirmation.html",address=address)
